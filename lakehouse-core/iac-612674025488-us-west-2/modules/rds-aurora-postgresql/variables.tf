...
variable "vpc_id" {
  description = "VPC ID where Aurora PostgreSQL cluster will be created"
  type        = string
}

variable "subnet_ids" {
  description = "List of subnet IDs for Aurora PostgreSQL cluster (must be public subnets for external access)"
  type        = list(string)
}
...
variable "deletion_protection" {
  description = "Whether to enable deletion protection for the Aurora PostgreSQL cluster"
  type        = bool
}
...
variable "auto_minor_version_upgrade" {
  description = "Whether to enable auto minor version upgrade for Aurora PostgreSQL instances"
  type        = bool
}

# Logging settings - PostgreSQL specific
variable "enabled_cloudwatch_logs_exports" {
  description = "List of log types to export to CloudWatch (postgresql supports: postgresql)"
  type        = list(string)
}
